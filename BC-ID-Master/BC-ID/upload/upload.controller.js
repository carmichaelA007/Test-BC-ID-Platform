(function () {
        ...
        function UploadController($location, AuthenticationService, FlashService, $rootScope, $scope, $http) {
            ...
            function upload() {
                ...
                return $http.post('http://139.59.89.16:8000/Mike-ID', vm.body).then(function (response) {
                        data = response.data;
                    })
                    ...
                    .then(() => {
                            ...
                            return $http.post('http://143.76.89.12:3000/api/', payload).then().catch((e)=>console.log(e))
                        .then(()=>{
